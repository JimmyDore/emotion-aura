...
<task type="auto">
  ...
  <action>
Add a public `applyForceField()` method to `ParticlePool`. This applies gesture-driven velocity modifications to particles within the influence radius.
...
<task type="auto">
  ...
  <action>
This is the integration task. Wire gesture classification, state, force fields, overlay, hand aura, and occlusion handling into main.ts.
